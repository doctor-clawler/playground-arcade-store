...
- Preserve the iframe sandbox and provenance filtering. Current games have session-limited storage in the opaque sandbox. Do not claim durable saves or Unity/Defold compatibility without testing.
